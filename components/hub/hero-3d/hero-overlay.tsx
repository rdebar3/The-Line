  ...
  return (
    <div className="hub-hero-3d-overlay">
      ...
      >
        ...
        <p className="hub-hero-3d-tagline">
          Know the standard. Hold the line.
        </p>

        <p className="hub-hero-3d-copy">
        ...
        <div className="hub-hero-3d-meta">
          <Link href="/quick-drills" className="hub-hero-3d-alt">
            <Zap className="size-3.5" />
            Quick Drills
          </Link>
          {showFreeLabel && (
            <span className="hub-hero-3d-free">
